...
public class SchoolDataOpenHelper extends SQLiteOpenHelper {

    private static final int DATABASE_VERSION = 3;
    private static final String DATABASE_NAME = "SchoolBusDB.db";
    private static final String TABLE_NAME = "Schooldb";
    ...
    SchoolDataOpenHelper(Context context) {
    ...
    public void saveData(SQLiteDatabase db, String title, int score){
        ...
        db.insert("Schooldb", null, values);
    }
}
